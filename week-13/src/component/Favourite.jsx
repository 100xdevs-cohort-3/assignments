...
const Favourite = () => {
  const redirect = () => {
    window.open(
      "https://leetcode.com/problemset/?page=1&difficulty=EASY",
      "_blank"
    );
  };
        ...
        <div className=" bg-secondaryColor p-6 md:p-6 rounded-xl w-full flex flex-col items-center md:items-start">
          ...
          <div className="w-full text-center md:text-left">
            ...
            <div className="flex w-full items-center gap-2 text-sm justify-center md:justify-start">
              ...
              <span className="flex gap-2 items-center justify-center  rounded-md py-2 px-2 ">
                <img
                  src={LockSvg}
                  alt="lock svg"
                ...
                <span className="w-3 h-3">
                  <img src={DropdownImg} alt="" className="w-full h-full" />
                </span>
              </span>
            </div>
            ...
            <div className="flex gap-2 py-6 md:border-b border-gray-600 justify-center md:justify-start">
              <Button
                icon={PlaySvg}
                text="Practice"
                className="primary-btn py-1 px-4"
                onClick={redirect}
              />
              <Button
                icon={ForkSvg}
                text=""
                className="round-btn cursor-default"
              />
            </div>
            ...
            <div className="md:hidden text-sm bg-primaryColor text-left max-w-48 py-2 flex gap-2 justify-center items-center px-4 rounded-lg ">
              <p>
                Progress: <span className=" text-lg  font-semibold">19</span>{" "}
                Solved
              </p>
              <span className="w-3 h-3 ">
                <img
